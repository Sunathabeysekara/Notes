...
<pre id="top">ICT/Papers/Y 13</pre>
        ...
        if($fileError===0){
            if($fileSize<12*1024*1024){
              ...
              // $fileDestination='PHP/uploads/ict/y2s2/'.$fileNameNew;
               ...
               $fileDestination='PHP/uploads/IT/y2s2/'.$fileName;//uploading with axixting filename
               move_uploaded_file($fileTempname, $fileDestination);

                   ////////////////insert file data into database- database name filesdatastl2s2(filename,filetype,filesize,fileowner)//////////////////////////////
                     $fileowner='N/A';
                    $query="insert into filesdatastl2s2 values('$fileName','$fileType','$fileSize','$fileowner')";
                    mysqli_query($connect,$query);

                    //////////////////////////////////////////////////////////////////////

                //header("Location:ictl2s2 - Copy.php");
            }else{
...
if(isset($_GET['submitstr'])){
    ...
    $query1="select * from filesdatastl2s2 where Filename like '%$searchtxt%' ";
...
$query2="select * from filesdatastl2s2;";
