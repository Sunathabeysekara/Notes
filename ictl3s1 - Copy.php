    ...
    <nav>
        ...
        <ul  class="navbar">
            ...
            <li><a href="#" class="text-dark">CHEMISTRY</a>
             ...
             <li><a href="#" class="text-dark">ICT</a>
                    <ul class="sublvl1">
                    <li><a href="#" class="text-dark">Notes</a>
                        <ul class="sublvl2">
...
<pre id="top">ICT/Answers/Y 12</pre>
        ...
        if($fileError===0){
            if($fileSize<12*1024*1024){
              ...
              // $fileDestination='PHP/uploads/ict/y3s1/'.$fileNameNew;
               ...
               $fileDestination='PHP/uploads/IT/y3s1/'.$fileName;//uploading with axixting filename
               move_uploaded_file($fileTempname, $fileDestination);

                   ////////////////insert file data into database- database name filesdatastl3s1(filename,filetype,filesize,fileowner)//////////////////////////////
                    $fileowner='N/A';
                    $query="insert into filesdatastl3s1 values('$fileName','$fileType','$fileSize','$fileowner')";
                    mysqli_query($connect,$query);

                    //////////////////////////////////////////////////////////////////////

               // header("Location:ictl3s1 - Copy.php");
            }else{
...
if(isset($_GET['submitstr'])){
    ...
    $query1="select * from filesdatastl3s1 where Filename like '%$searchtxt%' ";
...
$query2="select * from filesdatastl3s1;";
