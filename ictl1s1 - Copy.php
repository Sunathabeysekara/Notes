        ...
        if($fileError===0){
            if($fileSize<12*1024*1024){
              ...
              // $fileDestination='PHP/uploads/ict/y1s1/'.$fileNameNew;
               ...
               $fileDestination='PHP/uploads/IT/y1s1/'.$fileName;//uploading with axixting filename
               move_uploaded_file($fileTempname, $fileDestination);

                   ////////////////insert file data into database- database name filesdatastl1s1(filename,filetype,filesize,fileowner)//////////////////////////////
                     $fileowner='N/A';
                    $query="insert into filesdatastl1s1 values('$fileName','$fileType','$fileSize','$fileowner')";
                    mysqli_query($connect,$query);

                    //////////////////////////////////////////////////////////////////////

                //header("Location:ictl1s1 - Copy.php");
            }else{
...
if(isset($_GET['submitstr'])){
    ...
    $query1="select * from filesdatastl1s1 where Filename like '%$searchtxt%' ";
...
$query2="select * from filesdatastl1s1;";
